  ...
  const selectedItemsSection = useMemo(() => (
    <div className="bg-slate-50 p-3 sm:p-4 md:p-6 rounded-lg border border-slate-200 shadow-sm transition-all duration-300 hover:shadow-md">
      ...
      {selectedOptions.length === 0 ? (
        ...
        <div className="grid grid-cols-1 gap-2 sm:gap-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          {selectedOptions.map(option => (
            ...
            >
              <div className="flex items-center min-w-0 flex-1 mr-1">
                ...
                <span className="text-slate-700 font-medium truncate text-xs sm:text-sm" title={option.name}>
                  {option.name}
                </span>
              </div>
              <button 
            ...
            {availableOptions.map(option => (
              <div
                ...
                className={`flex flex-col items-center justify-center bg-white rounded-lg p-3 sm:p-4 md:p-5
                  min-w-[80px] sm:min-w-[100px] md:min-w-[115px] w-[calc(50%-0.5rem)] sm:w-auto
              ...
              >
                ...
                <span className="text-slate-700 font-medium text-center text-xs sm:text-sm md:text-base" title={option.name}>
                  {option.name}
                </span>
              </div>
            ))}
